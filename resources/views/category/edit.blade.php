                ...
                <table class="table table-borderless m-0">
                    <tr>
                        <td>
                            ...
                            <input type="text" id="nama_kategori" name="nama_kategori" id="nama_kategori" class="form-control w-100 @error('nama_kategori') is-invalid @enderror" value="{{ old('nama_kategori', $category->nama_kategori) }}" placeholder="Nama Kategori Buku" autofocus required>
                            @error('nama_kategori')
